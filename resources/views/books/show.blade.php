...
@section('content')
    <div class="container">
        ...
        @if(!auth()->user()->requests->where('book_id', $book->id)->isEmpty())
        ...
        <div class="alert alert-info mt-3">
            ...
            @else
                ...
                <small>Вы можете забронировать книгу и при её появлении Вы будете уведомлены.</small>
            @endif
            <br>
            Забронировали {{ $book->requests->count() }}
        </div>
    </div>
